...
eeg_data = pd.read_csv('raw_data.csv', skiprows=2)
...
np.save("states_predicted_real.npy", states_predicted)
np.save("measurements_predicted_real.npy", measurements_predicted)


data_states = "states_predicted_real.npy"
data_measurements = "measurements_predicted_real.npy"
states_predicted = np.load(data_states, allow_pickle = True)
measurements_predicted = np.load(data_measurements, allow_pickle = True)
plt.figure()
plt.plot(sensors_data[:,0], label = 'ground truth source 1')
plt.plot(measurements_predicted[:,0], label = 'predictions source 1')
plt.legend()
plt.show()
# plt.figure()
