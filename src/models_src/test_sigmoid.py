...
def main():
    ...
    sigmoid_model = SigmoidModel(state_dim, aug_state_dim, sources, dt, initial_x, initial_H, params_dict, Q_x, R_y, P_x_, P_x, P_params_, P_params, Q_params)
    states_predicted, measurements_predicted = sigmoid_model.fit(stimuli, measurements_noisy, states2)
